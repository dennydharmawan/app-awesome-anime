...
export type MediaQuery = (
  ...
  & { Media?: Maybe<(
    { __typename?: 'Media' }
    & Pick<Media, 'id' | 'bannerImage' | 'description' | 'season' | 'seasonYear' | 'type' | 'format' | 'status' | 'episodes' | 'duration' | 'chapters' | 'volumes' | 'genres' | 'synonyms' | 'source' | 'isAdult' | 'isLocked' | 'meanScore' | 'averageScore' | 'popularity' | 'favourites' | 'hashtag' | 'countryOfOrigin' | 'isLicensed' | 'isFavourite' | 'isRecommendationBlocked'>
    & { title?: Maybe<(
      { __typename?: 'MediaTitle' }
      ...
      & { pageInfo?: Maybe<(
        ...
        { __typename?: 'Review' }
        & Pick<Review, 'id' | 'summary' | 'rating' | 'ratingAmount'>
        & { user?: Maybe<(
          { __typename?: 'User' }
          & Pick<User, 'id' | 'name'>
          & { avatar?: Maybe<(
      ...
      { __typename?: 'MediaStreamingEpisode' }
      & Pick<MediaStreamingEpisode, 'site' | 'title' | 'thumbnail' | 'url'>
    )>>>, trailer?: Maybe<(
      { __typename?: 'MediaTrailer' }
...
export type GenreAndTagQueryVariables = Exact<{ [key: string]: never; }>;


export type GenreAndTagQuery = (
  { __typename?: 'Query' }
...
export type AnimeDashboardQueryVariables = Exact<{
  season?: Maybe<MediaSeason>;
  seasonYear?: Maybe<Scalars['Int']>;
...
export type AnimeDashboardQuery = (
  { __typename?: 'Query' }
  & { trending?: Maybe<(
    { __typename?: 'Page' }
...
export type ViewerQuery = (
  ...
  & { Viewer?: Maybe<(
    { __typename?: 'User' }
    & Pick<User, 'id' | 'name' | 'about' | 'bannerImage' | 'unreadNotificationCount' | 'donatorTier' | 'donatorBadge' | 'moderatorStatus'>
    & { avatar?: Maybe<(
      { __typename?: 'UserAvatar' }
      & Pick<UserAvatar, 'large'>
    )>, options?: Maybe<(
      { __typename?: 'UserOptions' }
      & Pick<UserOptions, 'titleLanguage' | 'airingNotifications' | 'displayAdultContent' | 'profileColor'>
      & { notificationOptions?: Maybe<Array<Maybe<(
        { __typename?: 'NotificationOption' }
        & Pick<NotificationOption, 'type' | 'enabled'>
      )>>> }
...
export const MediaDocument = gql`
  ...
  Media(id: $id, type: $type, isAdult: $isAdult) {
    ...
    `;
export const GenreAndTagDocument = gql`
    query genreAndTag {
  ...
  tags: MediaTagCollection {
    ...
    `;
export const AnimeDashboardDocument = gql`
    query AnimeDashboard($season: MediaSeason, $seasonYear: Int, $nextSeason: MediaSeason, $nextYear: Int) {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    media(variables?: MediaQueryVariables): Promise<MediaQuery> {
      return withWrapper(() => client.request<MediaQuery>(print(MediaDocument), variables));
    },
    genreAndTag(variables?: GenreAndTagQueryVariables): Promise<GenreAndTagQuery> {
      return withWrapper(() => client.request<GenreAndTagQuery>(print(GenreAndTagDocument), variables));
    },
